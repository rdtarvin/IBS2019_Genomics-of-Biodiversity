...
There is a lot to explore with [vi](https://kb.iu.edu/d/afdc), but let's leave that for another time. 
...
The general code we will use for process_radtags, running it from within the epi folder, is the following: 
	...
	process_radtags -P -p . -b ./epi_barcodes_final.txt -o ./demultiplex -c -q -r -D --inline_null --renz_1 sphI --renz_2 mluCI -i gzfastq 
<br>
